...
`corrupt/` contains deliberately invalid, redistributable ARW-named byte
streams. They exercise the CLI and decoder failure paths without carrying any
camera pixels or metadata.
